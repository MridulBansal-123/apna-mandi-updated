...
export default function ProfilePage() {
    ...
    return (
        <>
            ...
            <div className="space-y-6 px-4 sm:px-6 md:px-8 max-w-full">
                {/* Header: stack on very small with spacing */}
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
                    ...
                    <div className="flex items-center space-x-3">
                        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-purple-400 to-pink-500 rounded-full flex items-center justify-center shadow-lg shadow-purple-500/30 text-lg font-bold text-white">
                            {user.name?.charAt(0)?.toUpperCase() || 'U'}
                        </div>
                        <div className="min-w-0">
                            <p className="font-medium text-gray-900 dark:text-dark-900 text-sm truncate">{user.name}</p>
                            <p className="text-xs sm:text-sm text-gray-500 dark:text-dark-500 truncate">{user.role}</p>
                        </div>
                    </div>
                </div>

                {/* Profile Form */}
                <div className="relative glass-effect rounded-3xl p-6 sm:p-8 border border-white/20 dark:border-gray-700/50 backdrop-blur-xl max-w-full">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
                        {/* Name Field */}
                        <div className="group">
                            <label className="block text-sm font-medium text-gray-900 dark:text-dark-900 mb-1 sm:mb-2">
                                Owner Name
                            </label>
                        ...
                        <div className="group">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    className="w-full pl-10 sm:pl-12 pr-3 sm:pr-4 py-3 sm:py-4 glass-effect border border-blue-200/50 dark:border-blue-700/50 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 text-gray-900 dark:text-dark-900 placeholder-gray-500 dark:placeholder-dark-400 transition-all duration-300"
                                    required
                                />
                        ...
                        <div className="group">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    className="w-full pl-10 sm:pl-12 pr-3 sm:pr-4 py-3 sm:py-4 glass-effect border border-green-200/50 dark:border-green-700/50 rounded-2xl focus:outline-none focus:ring-2 focus:ring-green-500/50 focus:border-green-500/50 text-gray-900 dark:text-dark-900 placeholder-gray-500 dark:placeholder-dark-400 transition-all duration-300"
                                    required
                                />
                        ...
                        <div className="space-y-5 sm:space-y-6">
                            ...
                            {/* City and Pincode: stacked on xs, side-by-side on md */}
                                ...
                                <div className="group">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            onChange={handleChange}
                                            className="w-full pl-10 sm:pl-12 pr-3 sm:pr-4 py-3 sm:py-4 glass-effect border border-red-200/50 dark:border-red-700/50 rounded-2xl focus:outline-none focus:ring-2 focus:ring-red-500/50 focus:border-red-500/50 text-gray-900 dark:text-dark-900 placeholder-gray-500 dark:placeholder-dark-400 transition-all duration-300"
                                            required
                                        />
                ...
                {/* Danger Zone */}
                <div className="relative glass-effect rounded-3xl p-6 sm:p-8 border border-red-200/30 dark:border-red-700/50 backdrop-blur-xl max-w-full">
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-4">
                        <div className="flex-shrink-0">
                            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-red-500 to-pink-500 rounded-2xl flex items-center justify-center shadow-lg shadow-red-500/30">
                        ...
                        <div className="flex-1 min-w-0">
                            <h3 className="text-lg font-semibold bg-gradient-to-r from-red-600 to-pink-600 bg-clip-text text-transparent truncate">
                                Danger Zone
                            </h3>
                            <p className="text-sm text-gray-600 dark:text-dark-400 mt-1 mb-4 max-w-full">
                                Deleting your account is a permanent action and cannot be undone. All your data will be permanently removed.
                            </p>
                            <button
                                onClick={() => setIsDeleteModalOpen(true)}
                                className="group relative overflow-hidden bg-gradient-to-r from-red-500 to-pink-600 text-white font-medium py-3 px-6 rounded-2xl hover:from-red-600 hover:to-pink-700 transition-all duration-300 shadow-lg shadow-red-500/30 hover:shadow-red-500/50 hover:shadow-xl transform hover:-translate-y-0.5 w-full sm:w-auto text-center"
                                type="button"
                            >
